...
public class Constant {
    ...
    public static final String UPDATE_POST = BOOKS +"/update";
    public static final String DELETE_POST = BOOKS +"/delete";
    public static final String LIKE_POST = BOOKS +"/like";
    ...
    public static final String MY_POST = BOOKS +"/my_posts";
    public static final String ADD_USER = HOME+"/users/writer";
